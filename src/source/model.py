...
ENTROPY_BETA        = 0.01
PPO_STEPS           = 2048  #256
MINI_BATCH_SIZE     = 512 #64 i guess this was supposed to be 256/64 = 4 ? ppo_iter like frame our state is 25 element.
PPO_EPOCHS          = 10
TEST_EPOCHS         = 10
NUM_TESTS           = 10
TARGET_REWARD       = 2500
...
def test_env(baseline_racer, model, device,testIndex, deterministic=True):
    ...
    while not done and timeout>= 0:
        ...
        print("Test # Current Position,",testIndex,pose_object_temp.x_val,pose_object_temp.y_val,pose_object_temp.z_val,"\n")
        ...
        print("Test # Linear Velocity,",testIndex,linear_vel_object_temp.x_val,linear_vel_object_temp.y_val,linear_vel_object_temp.z_val,"\n")

        angular_vel_object_temp = baseline_racer.current_angular_velocity
        print("Test # Angular Velocity,",testIndex,angular_vel_object_temp.x_val,angular_vel_object_temp.y_val,angular_vel_object_temp.z_val,"\n")
        ...
        print("Test # Enemy Position,",testIndex," ",enemy.position.x_val,enemy.position.y_val,enemy.position.z_val,"\n")
        ...
        print("Test # Reward ",testIndex,," ",reward,"\n")
